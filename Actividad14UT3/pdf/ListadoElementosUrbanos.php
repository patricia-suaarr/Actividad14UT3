...
//Logo
	$this->Image("../imagenes/Logo.jpg", 5, 5, 50, 25, "JPG");
      ...
      //T�tulo
		...
		//$this->Cell(80);
		$this->Cell(160,10,utf8_decode('Listado Dispositivo IOT'),2,0,'R');
		$this->Ln();
		$this->Cell(70);
...
function Footer()
{
    ...
    // N�mero de página
    $this->Cell(0,10,'CIFP Santa Catalina Patricia Sualdea ' ,0,0,'C');
...
$pdf->Cell(80,$alturafila2,utf8_decode('Cantidad '),1,0,'C');
$pdf->Cell(14,$alturafila2,utf8_decode('Fecha'),1,0,'L',True);
$pdf->Cell(20,$alturafila2,utf8_decode('Direccion'),1,0,'C');
...
if ($connect->connect_errno) {
    ...
    if (!$resultado) {
        ...
        while ($fila = mysqli_fetch_row($resultado)) {
			...
			$pdf->Cell($w[4],$alturafila2,utf8_decode($fila[6]),1,0,'R',$pintaFondo);
			$pdf->Ln();
...
//crea el fichero aqui y le descarga  
